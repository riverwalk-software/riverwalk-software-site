...
export default function Example() {
  ...
  return (
    <Fragment>
      <button
        onClick={toggleShow}
        className="rounded-md bg-cta px-3.5 py-2.5 text-base font-semibold text-gray-100 shadow-sm hover:bg-accent-1 hover:text-gray-100 hover:no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
      >
        <span className="text-white">Take this course {show.toString()}</span>
      </button>
      <div
        className={`card-shadow-color card-shadow transform-[translate(-50%, -50%)] fixed left-1/2 top-1/2 isolate my-16 max-w-5xl rounded-3xl bg-secondary px-6 py-8 sm:py-12 lg:mx-32`}
      >
